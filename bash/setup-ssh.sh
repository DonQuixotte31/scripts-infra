...
# - créer un fichier generate-ssh-key-and-git-conf.bash sur le bureau du téléporteur
# - y copier tout ce script et enregistrer le fichier
# - lancer un terminal et accéder au bureau :
#       cd ~/Bureau
# - exécuter le script :
